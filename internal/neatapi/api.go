...
import (
	...
	"github.com/Gessiux/neatchain/blockchain/consensus/neatbyft/epoch"
...
// Sign calculates an NEAT Chain ECDSA signature for:
...
//
// https://github.com/Gessiux/neatchain/wiki/Management-APIs#personal_sign
...
//
// https://github.com/Gessiux/neatchain/wiki/Management-APIs#personal_ecRecover
func (s *PrivateAccountAPI) EcRecover(ctx context.Context, data, sig hexutil.Bytes) (string, error) {
	...
	if sig[64] != 27 && sig[64] != 28 {
		return "", fmt.Errorf("invalid NEAT Chain signature (V is not 27 or 28)")
	}
...
func (args *SendTxArgs) setDefaults(ctx context.Context, b Backend) error {
	...
	if neatAbi.IsNeatChainContractAddr(args.To) {
		...
		if len(input) == 0 {
			return errors.New(`neatchain contract without any data provided`)
		}
...
// PublicDebugAPI is the collection of NEAT Chain APIs exposed over the public
// debugging endpoint.
...
// PrivateDebugAPI is the collection of NEAT Chain APIs exposed over the private
// debugging endpoint.
...
// Version returns the current neatchain protocol version.
