...
var makeTest = function(tx, rewind) {
  ...
  var block   = neatptc.getBlock(neatptc.getTransaction(tx).blockHash);
  var genesis = neatptc.getBlock(block.parentHash);
  ...
  genesis.config = admin.nodeInfo.protocols.neatptc.config;
  ...
  console.log(JSON.stringify({
    ...
    input:  neatptc.getRawTransaction(tx),
    result: result,
  }, null, 2));
}
*/
