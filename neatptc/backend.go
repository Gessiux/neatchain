...
import (
	...
	neatconBackend "github.com/Gessiux/neatchain/blockchain/consensus/neatbyft"
	"github.com/Gessiux/neatchain/blockchain/core"
	"github.com/Gessiux/neatchain/blockchain/core/bloombits"
	"github.com/Gessiux/neatchain/blockchain/core/datareduction"
	...
	"github.com/Gessiux/neatchain/neatptc/filters"
	...
	"github.com/Gessiux/neatchain/utilities/miner"
...
func New(ctx *node.ServiceContext, config *Config, cliCtx *cli.Context,
	...
	chainDb, err := ctx.OpenDatabase("chaindata", config.DatabaseCache, config.DatabaseHandles, "neatchain/db/chaindata/")
	if err != nil {
		return nil, err
	}
	pruneDb, err := ctx.OpenDatabase("prunedata", config.DatabaseCache, config.DatabaseHandles, "neatchain/db/prune/")
	if err != nil {
		return nil, err
	}
