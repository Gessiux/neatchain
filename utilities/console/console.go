...
func (c *Console) init(preload []string) error {
	...
	//c.jsre.Run(`var GlobalRegistrar = neatptc.contract(` + registrar.GlobalRegistrarAbi + `);   registrar = GlobalRegistrar.at("` + registrar.GlobalRegistrarAddr + `");`)
...
func (c *Console) AutoCompleteInput(line string, pos int) (string, []string, string) {
	...
	// E.g. in case of nested lines neatptc.getBalance(neatptc.coinb<tab><tab>
	start := pos - 1
	for ; start > 0; start-- {
