...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "neatchain.ipc", false, filepath.Join(os.TempDir(), "neatchain.ipc")},
		{"data", "neatchain.ipc", false, "data/neatchain.ipc"},
		{"data", "./neatchain.ipc", false, "./neatchain.ipc"},
		{"data", "/neatchain.ipc", false, "/neatchain.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "neatchain.ipc", true, `\\.\pipe\neatchain.ipc`},
		{"data", "neatchain.ipc", true, `\\.\pipe\neatchain.ipc`},
		{"data", `\\.\pipe\neatchain.ipc`, true, `\\.\pipe\neatchain.ipc`},
	}
