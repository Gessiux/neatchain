...
import (
	...
	"github.com/Gessiux/neatchain/internal/web3ext"
...
func (c *Console) init(preload []string) error {
	...
	//c.jsre.Run(`var GlobalRegistrar = neatprotocol.contract(` + registrar.GlobalRegistrarAbi + `);   registrar = GlobalRegistrar.at("` + registrar.GlobalRegistrarAddr + `");`)
...
func (c *Console) AutoCompleteInput(line string, pos int) (string, []string, string) {
	...
	// E.g. in case of nested lines neatprotocol.getBalance(neatprotocol.coinb<tab><tab>
	start := pos - 1
	for ; start > 0; start-- {
...
// Welcome show summary of current neatchain instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic neatchain metadata
	fmt.Fprintf(c.printer, "Welcome to the NEATChain JavaScript console!\n\n")
	c.jsre.Run(`
