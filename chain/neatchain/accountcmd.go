...
var (
	walletCommand = cli.Command{
		...
		Description: `
    neatchain wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	neatchain wallet [options] /path/to/my/presale.wallet
...
`,
			},
			{
				...
				Description: `
    neatchain account update <address>
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    neatchain account update [options] <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    neatchain account import <keyfile>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    neatchain account import [options] <keyfile>
