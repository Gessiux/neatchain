...
import (
	...
	"github.com/Gessiux/neatchain/blockchain/consensus/neatbyft/types"
	...
	"github.com/Gessiux/neatchain/neatcli"
	"github.com/Gessiux/neatchain/neatptc"
...
func (cm *ChainManager) InitCrossChainHelper() {
	...
	cm.cch.localTX3CacheDB, _ = rawdb.NewLevelDBDatabase(path.Join(cm.ctx.GlobalString(utils.DataDirFlag.Name), "tx3cache"), 0, 0, "neatchain/db/tx3/")
