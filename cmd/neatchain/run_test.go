...
import (
	...
	"github.com/Gessiux/neatchain/internal/cmdtest"
	"github.com/docker/docker/pkg/reexec"
)

func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "neatchain-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func runintchain(t *testing.T, args ...string) *testintchain {
	...
	// Boot "neatchain". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("neatchain-test", args...)
