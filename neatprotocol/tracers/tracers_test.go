...
import (
	...
	"github.com/Gessiux/neatchain/tests"
)
...
var makeTest = function(tx, rewind) {
  ...
  var block   = neatprotocol.getBlock(neatprotocol.getTransaction(tx).blockHash);
  var genesis = neatprotocol.getBlock(block.parentHash);
  ...
  genesis.config = admin.nodeInfo.protocols.neatprotocol.config;
  ...
  console.log(JSON.stringify({
    ...
    input:  neatprotocol.getRawTransaction(tx),
    result: result,
  }, null, 2));
}
*/
